...
| `incidents.json` | **Generated view** of the [genai_incidents](https://github.com/emmanuelgjr/genai_incidents) source of truth (125 curated incidents) — produced by `scripts/sync-incidents.mjs`; do not hand-edit |
