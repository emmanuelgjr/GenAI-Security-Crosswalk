...
- Publishing others' private information (physical or electronic address)
  without explicit permission
- Deliberate misrepresentation of security research or findings
- Submitting malicious code, harmful content, or deliberate misinformation
...
be reported by contacting the project maintainers via the repository's
issue tracker or by emailing the OWASP GenAI Data Security Initiative
leadership at [genai-security@owasp.org](mailto:genai-security@owasp.org).
