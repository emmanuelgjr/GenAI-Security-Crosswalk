...
| [Agentic_NHI.md](agentic-top10/Agentic_NHI.md) | OWASP NHI Top 10 | 完全なNHI対ASIクロスマッピング、NHIプログラム成熟度テーブル |
...
→ 次に：[Agentic_NHI.md](agentic-top10/Agentic_NHI.md) — アイデンティティおよび資格情報コントロール
...
**自律エージェントのデプロイ**
→ [Agentic_NHI.md](agentic-top10/Agentic_NHI.md) — アイデンティティガバナンス
...
[Agentic_NHI.md](agentic-top10/Agentic_NHI.md)は、すべてのNHI Top 10エントリをすべてのASIエントリにマッピングしています — エージェントセキュリティリスクをIAMチームが既に運用しているNHIコントロールに変換した唯一の公開ドキュメントです。
