...
const FRAMEWORK_FILES = [
  ...
  { rel: 'agentic-top10/Agentic_STRIDE.md',         framework: 'STRIDE',                  ids: ASI_IDS },
  ...
  { rel: 'dsgai-2026/DSGAI_STRIDE.md',      framework: 'STRIDE',                   ids: DSGAI_IDS },
    ...
    for (const inc of incDb.incidents) {
      for (const eid of (inc.owasp_entries || [])) {
        ...
        incidentsByEntry[eid].push({
          name:        inc.title,
          url:         `https://emmanuelgjr.github.io/genai_incidents/incident/${inc.id}.html`,
          year:        inc.year,
          incident_id: inc.id,
        });
      }
