...
<p align="center">
  ...
  <a href="README.md"><img src="https://img.shields.io/badge/controls-1,511-blueviolet" alt="Controls"></a>
...
<p align="center">
  ...
  25 frameworks &middot; 1,511 controls &middot; 41 entries &middot; 3,351 mappings &middot; 125 incidents &middot; ML classifier pipeline
</p>
...
python -m classifier.index_builder            # build FAISS index (1,511 controls, ~7s)
...
| **25** framework registries | First-class control inventories (1,511 controls) with backlink index |
...
│
├── data/
│   ├── frameworks/                  ← 25 framework registries (1,511 controls)
...
│   ├── index_builder.py             ← FAISS index builder (1,511 controls)
