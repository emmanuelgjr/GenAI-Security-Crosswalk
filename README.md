...
<p align="center">
  ...
  <a href="README.md"><img src="https://img.shields.io/badge/controls-1,016-blueviolet" alt="Controls"></a>
...
<p align="center">
  ...
  25 frameworks &middot; 1,016 controls &middot; 41 entries &middot; 3,351 mappings &middot; 125 incidents &middot; ML classifier pipeline
</p>
...
python -m classifier.index_builder            # build FAISS index (1,016 controls, ~7s)
...
| **25** framework registries | First-class control inventories (1,016 controls) with backlink index |
...
### Agentic Top 10 2026 — 24 framework mappings
...
| [Agentic_STRIDE.md](agentic-top10/Agentic_STRIDE.md) | STRIDE | Threat-model categories (S/T/R/I/D/E) per agentic risk with tiered mitigations |
...
### DSGAI 2026 — 23 framework mappings
...
| [DSGAI_STRIDE.md](dsgai-2026/DSGAI_STRIDE.md) | STRIDE | Threat-model categories (S/T/R/I/D/E) per DSGAI risk — I/T-dominant, with tiered mitigations |
...
│
├── data/
│   ├── frameworks/                  ← 25 framework registries (1,016 controls)
...
│   ├── index_builder.py             ← FAISS index builder (1,016 controls)
